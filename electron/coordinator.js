...
function buildCoordinatorPrompt(conversation, repos, opts = {}) {
  ...
  promptParts.push(
    ...
    '',
    'No puedes delegar mas permiso del que tienes tu mismo: si estas en modo lectura o plan, un',
    'pedido con "mode": "write" o "auto" se rechaza. Pide el modo que corresponde o devuelvele la',
    'tarea a la persona -- no la reintentes con otro nombre.',
    '',
    ...
    '',
    'Cada worker te avisa solo cuando arranca, cuando se bloquea y cuando termina, y ese aviso',
    'llega a tu terminal. Asi que leelo cuando llegue un aviso o antes de decidir algo, no en un',
    'loop mientras esperas: releer el estado no apura a nadie y te gasta el contexto que vas a',
    'necesitar para repartir el trabajo que viene.',
    '',
